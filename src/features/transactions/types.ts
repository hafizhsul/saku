...
// Label sama dengan key agar konsisten di semua layar (R-31): tidak ada lagi
// "Makanan"/"Transport"/"Belanja"/"Tagihan" yang berbeda dari nama kategori
// tersimpan. Key tidak berubah sehingga data lama tetap terpetakan.
